...
function NumPadComponent(props) {
        ...
        <div className={classes.root}>
            <Grid container direction={"column"}>
                ...
                <Grid container dir={"row"}>
                    <Grid item xs={4} className="flex justify-content">
                        <Button className={classes.button} name="0" onClick={(e) => props.onClick(e.target.innerText)}>00</Button>
                    </Grid>
                    <Grid item xs={4} className="flex justify-content">
                        <Button className={classes.button} name="0" onClick={(e) => props.onClick(e.target.innerText)}>0</Button>
                    </Grid>
                    <Grid item xs={4} className="flex justify-content">
                        <Fab classes={{disabled: classes.disabledButton}} className={classes.button} disabled={disable} aria-label="delete" onClick={() => props.onClick('=')}>
                            <Back fill={'white'}/>
                        </Fab>
                    </Grid>
                </Grid>
