...
import SvgAddBig from "../../../Icons/AddBig";
...
function ReceiptPrinter(props) {
    ...
    return (
        <div className='checkoutBody'>
            <AddPrinterDialog open={addPrinter} onClose={() => setAddPrinter(false)} addPrinter={(data) => addNewPrinter(data)} tag={false}/>
            <EditPrinterDialog open={editPrinter} onClose={() => setEditPrinter(false)} addPrinter={(data) => editNewPrinter(data)} data={printers[printerIndex]} tag={false}/>
            <div
