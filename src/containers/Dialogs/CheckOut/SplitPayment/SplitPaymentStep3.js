...
import SvgContinueSale from "../../../../Icons/ContinueSale";
...
function SplitPaymentStep3(props) {
    ...
    return (
        <div className='checkoutBody'>
            <div className='pt-105 flex flex-col justify-content align-center'>
                ...
                <div className='flex flex-row justify-content align-center pt-10'>
                    <p className='p-0 m-0 color-light-black fs-12 width-100 text-right'>
                        Paid
                    </p>
                    <div className='width-42'></div>
                    <p className='p-0 m-0 color-light-black fs-12 width-100'>
                        Change due
                    </p>
                </div>
            </div>
            ...
            <div className='pt-40 pl-20 pr-20'>
                <Button
                    ...
                    startIcon={props.isLast ? <SvgCompleteSale/> : <SvgContinueSale/>}
                >{props.isLast ? 'Complete' : 'Continue sale'}</Button>
            </div>
...
export default SplitPaymentStep3;
