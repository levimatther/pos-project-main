...
function SalesDeleteDialog(props) {
        ...
        <Dialog open={props.open} classes={{paper: classes.dialogPaper}} TransitionComponent={Transition}
            ...
            <div className='p-20'>
                <div className='text-area height-20'>
                    <p className='p-0 m-0 fs-16 fw-bold color-light-blue'>Delete pending sale</p>
                </div>
            </div>
            <div className='pl-20'>
                <div className='text-area height-17'>
                    <p className='p-0 m-0 fs-14 color-light-blue'>Are you sure you want to delete the pending sale?</p>
                </div>
            </div>
            ...
            <div className='pt-40 flex flex-row justify-end pr-20 pb-20'>
                ...
                <Button variant="contained" className={classes.openBtn} onClick={props.handleDelete}>Delete</Button>
            </div>
        </Dialog>
    )
}
