...
import SvgPartialRefund from "../../../Icons/PartialRefund";
...
function PurchaseHistoryModalDialog(props) {
                        ...
                        <div className='pt-20 flex flex-row justify-between cursor-pointer' onClick={() => setPurchaseDetail(true)}>
                            <div className='flex flex-col height-40 justify-between'>
                                ...
                                <div className='flex flex-row'>
                                    <p className='p-0 m-0 fs-12 color-light-black width-60'>#12003</p>
                                    <SvgPaid />
                                    {/*<SvgCircleB/>*/}
...
export default PurchaseHistoryModalDialog;
