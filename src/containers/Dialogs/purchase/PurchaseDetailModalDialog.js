...
import {Button, Popover, Icon, IconButton} from "@material-ui/core";
...
import ReturnProductsEmptyDialog from "../ReturnProducts/RefundProductsEmptyDialog";
import PurchaseAddNoteDialog from "./PurchaseAddNoteDialog";
...
function PurchaseDetailModalDialog(props) {
    ...
    return (
        <div className='checkoutBody'>
            ...
            />
            <div
                className='pl-5 pr-5 flex flex-row justify-between height-50 align-center borderBottomLight backgroundWhite'>
                <Button
                    startIcon={<ArrowLeftIcon/>}
                    classes={{startIcon: classes.startIcon}}
                    color='primary' className={classes.openBtn} onClick={props.handleCancel}>Back</Button>
                <p className='p-0 m-0 fs-14 color-light-blue'>#SW-1-2293</p>
            ...
            <div style={{height: 'calc(100vh - 51px)', overflowY: 'auto'}}>
                {/*Price section*/}
...
export default PurchaseDetailModalDialog;
